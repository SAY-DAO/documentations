...
فرآیند جمع‌آوری داده‌ها از افراد در شرایط سخت بسیار پرهزینه است و در مواردی این داده‌ها به‌روزرسانی نمی‌شوند یا حتی برخی از کشورها به دلیل نبود داده‌های کافی نادیده گرفته می‌شوند.<sup><a href="/guide/family/references.html#_1-collecting-data-is-a-challenging-task">[1]</a></sup>
<br />
