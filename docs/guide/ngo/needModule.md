...
## مسئله
 ...
 فرآیند جمع‌آوری اطلاعات از افراد در شرایط سخت کاری بسیار پرهزینه است، موضوعی که در برخی موارد مانع به‌روزرسانی این داده‌ها شده و حتی در بعضی کشورها منجر به نادیده گرفته شدن آنها شده است.<sup><a href="/guide/ngo/references.html#_1-collecting-data-is-a-challenging-task">[1]</a></sup>
<br />
...
[اپلیکیشنی](https://dapp.saydao.org) در اختیار کاربران قرار می‌گیرد تا با پذیرفتن یکی از نقش‌ها (پدر، مادر، عمو، خاله، دایی یا عمه) عضو خانواده مجازی کودکان شوند. برای حفاظت از حریم خصوصی، آواتاری خاص و نامی متفاوت برای صفحه کودک انتخاب می‌شود. کاربران می‌توانند صدای واقعی کودک را بشنوند، داستانی کوتاه از زندگی او بخوانند و هزینه‌ی نیازهای ثبت‌شده را، به‌تنهایی یا با همراهی دیگر اعضای خانواده مجازی، پرداخت کنند.

این سیستم به گونه‌ای طراحی شده که در عین حفظ حریم خصوصی کودکان، تعامل شفاف، امن و بدون نیاز به اعتماد میان طرفین برقرار باشد.
